...
// Mock images since we don't have the actual assets, but we'll use placeholder local requires
// In a real app, these would be real image assets.
const MOCK_IMG = require('@/assets/images/image.png');
